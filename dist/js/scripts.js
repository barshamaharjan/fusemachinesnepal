$(document).ready(function(){
	...
	//=career page modal ficed top
	var controller = new ScrollMagic.Controller();

	var pintopmenu = new ScrollMagic.Scene({
		triggerElement: '#modalspace1',
		triggerHook : 0,
		duration: '300%'
	})
	.setPin('#modalspace1')
	...
	var pintopmenu2 = new ScrollMagic.Scene({
		triggerElement: '#modalspace2',
		triggerHook : 0,
		duration: '300%'
	})
	.setPin('#modalspace2')
	...
	// move the box up to connect with the first part
	TweenMax.set('.part3', {y: -750});

	// create a tween that will move the box back to its original css position
	var bodyToStart = TweenMax.to('.part3', 1, {y: 0, ease:Linear.easeNone});

	// Init ScrollMagic Controller
	var controller = new ScrollMagic.Controller();

	// Create a Scene 1 - move box back to start
